...
<meta charset="UTF-8">
    ...
    <title>gm</title>
    <link rel="stylesheet" href="../src/assets/build-tools/bootstrap/css/bootstrap.css">
    <link rel="stylesheet" href="../src/assets/build-tools/bootstrap/icons/bootstrap-icons.css">
    <link rel="stylesheet" href="../src/assets/build-tools/Hover-master/css/hover.css">
    <link rel="shortcut icon" href="../src/assets/img/2021/tub.png">
    <script src="../src/assets/build-tools/bootstrap/js/jquery.min.js"></script>
    <script src="../src/assets/build-tools/bootstrap/js/bootstrap.js"></script>
...
<body>
    <div id="all">
        <div id="all-img">
            <?php
                $sql="SELECT * FROM `gm` ORDER BY tim DESC";
